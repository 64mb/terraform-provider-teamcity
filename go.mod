module github.com/64mb/terraform-provider-teamcity

go 1.22

replace github.com/64mb/go-teamcity v1.3.0 => ../go-teamcity

require (
	github.com/64mb/go-teamcity v1.3.0
...
require (
	...
	github.com/64mb/go-loghttp v0.0.1 // indirect
	github.com/64mb/go-nuts v0.0.1 // indirect
